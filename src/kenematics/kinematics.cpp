// #include "kenimatics/kinematics.h"
...
// template <>
// CalculationResult_t Kinematics<6>::forward(const std::vector<calc_t> &joints, Position_t &out)
// {
...
// template <>
// CalculationResult_t Kinematics<6>::inverse(const Position_t &pos, std::vector<calc_t> &out, config_t conf)
// {
