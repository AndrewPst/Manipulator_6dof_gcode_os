...
template<>
CalculationResult_t Kinematics<6>::forward(const std::vector<double>& joints, Position_t& out)
{
...
template<>
CalculationResult_t Kinematics<6>::inverse(const Position_t& pos, std::vector<double>& out, config_t conf)
{    
